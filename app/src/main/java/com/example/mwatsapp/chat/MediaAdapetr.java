...
import com.example.mwatsapp.R;

import java.util.ArrayList;

public class MediaAdapetr extends RecyclerView.Adapter<MediaAdapetr.MediaViewHolder>{

    ArrayList<String> mediaList;
    Context context;

    public MediaAdapetr(Context context, ArrayList<String> mediaList){
